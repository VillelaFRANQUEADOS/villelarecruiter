...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "ATS do Grupo Villela: candidatos, pipeline e agendamento centralizados." },
      ...
      { property: "og:description", content: "ATS do Grupo Villela: candidatos, pipeline e agendamento centralizados." },
      { name: "twitter:description", content: "ATS do Grupo Villela: candidatos, pipeline e agendamento centralizados." },

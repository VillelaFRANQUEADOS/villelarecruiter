...
const DASHBOARD_SELECT = "id,nome,status,estado,cidade,vaga,origem_curriculo,recrutador_id,created_at,updated_at,data_entrevista,entrevistador,telefone,email";
const DASHBOARD_CHUNK = 1000;
export interface DashboardRow { id:string; nome:string; status:string; estado:string|null; cidade:string|null; vaga:string|null; origem_curriculo:string; recrutador_id:string|null; created_at:string; updated_at:string|null; data_entrevista:string|null; entrevistador:string|null; telefone:string|null; email:string|null; }
